...
class List:
    ...
    def list_iteration(self, number, left, right, index):
        list_iter = Iterator(number, left, right)
        for i in list_iter:
            self.add_new_node(i, index)

    def list_generation(self, number, left, right, index):
        list_gen = generator(number, left, right)
        for i in list_gen:
            self.add_new_node(i, index)
